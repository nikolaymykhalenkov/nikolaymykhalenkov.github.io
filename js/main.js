$(document).ready(function() {
	...
	$("#menu-item-2").click(function() {
		$("#content-tab").append("<div class='content-item'><h2>Portfolio</h2><p>My last work was <a href='http://www.render-room.com'>website</a> for guys from Render Room. Now I`m working on <a href='http://www.bolgov.kiev.ua'>website</a> for surgeon Michael Bolgov.</p><p>Also, now I`m working on a game using Unity 3D and C#.</p></div>");
	});
