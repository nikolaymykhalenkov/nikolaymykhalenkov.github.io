$(document).ready(function() {
	...
	$("#menu-item-2").click(function() {
		$("#content-tab").append("<div class='content-item'><h2>Portfolio</h2><p>I have created website for <a href='render-room.com'>Render-Room</a> and <a href='bolgov.kiev.ua'>Bolgov</a>.</p></div>");
	});
